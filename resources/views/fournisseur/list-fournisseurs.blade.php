                                        ...
                                        <div class="dropdown dropstart">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownTeamOne">
                                                <a class="dropdown-item"
                                                    href="{{ route('fournisseur.edit', ['fournisseur' => $fournisseur->id]) }}">Modifier</a>
                                                <form
                                                    action="{{ route('fournisseur.destroy', ['fournisseur' => $fournisseur->id]) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ route('fournisseur.show', ['fournisseur' => $fournisseur->id]) }}">Détails
                                                    fournisseur</a>
                                            </div>
                                        </div>
                                    </td>
