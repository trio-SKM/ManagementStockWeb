...
<body>
    ...
    <input type="text" id="nb_clients" readonly value=""><br>
    <label for="nb_fournisseurs">Nombre des fournisseurs</label>
    <input type="text" id="nb_fournisseurs" readonly value=""><br>
    <label for="gains">Les gains</label>
    <input type="text" id="gains" readonly value=""><br>
    <label for="expenses">Les depenses</label>
    <input type="text" id="expenses" readonly value=""><br>
    <label for="credit">Credit</label>
    <input type="text" id="credit" readonly value=""><br>
    <label for="dette">Dette</label>
    <input type="text" id="dette" readonly value=""><br>
    <label for="nb_clients_with_credit">Nombre des clients ayant des credits</label>
    <input type="text" id="nb_clients_with_credit" readonly value="">
    <button id="btn_clients_with_credit">Voir</button><br>
    <label for="nb_fournisseurs_with_dette">Nombre des fournisseurs ayant dettes</label>
    <input type="text" id="nb_fournisseurs_with_dette" readonly value="">
    <button id="btn_fournisseurs_with_dette">Voir</button><br> --}}
    ...
    @else
        <div>
            <p>Il y a aucun produit avec petit quantité ce moment.</p>
        </div>
    @endif --}}
