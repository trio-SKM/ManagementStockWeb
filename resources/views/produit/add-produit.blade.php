                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('produit.store') }}" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" placeholder="Entre le nom REF de produit" type="text"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" placeholder="Entre le prix d'achat de produit" type="text"
                                        id="produit_price_buy" name="produit_price_buy" value="{{ old('produit_price_buy') }}">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="rc">Quantité en stock</label>
                                    <input class="form-control" placeholder="Entre la quantité en stock de produit" type="text"
                                        id="produit_qte" name="produit_qte" value="{{ old('produit_qte') }}">
                                </div>
                                <div class="mb-3">
...
=======
        ...
        <div class="mb-3">
            <label class="form-label" for="produit_qte">Quantité</label>
            <input class="form-control" placeholder="Entre QTE" type="text" id="produit_qte" name="produit_qte" value="{{ old('produit_qte') }}">
        </div>
        <div class="mb-3">
...
>>>>>>> 924685b (Integration de pages devis)
                </div>
            </div>
        </div>
    </div>
